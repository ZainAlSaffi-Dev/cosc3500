...
\begin{frame}{Levels 3 and 4}{Null by construction}
  ...
  \sigcallout{Both nulls say the baseline was already written correctly.
    The deliberately swapped version on the ladder slide shows what the
    traversal order is worth. The per-level code is in the backup slides.}
\end{frame}
