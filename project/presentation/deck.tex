...
\begin{frame}{The ladder, measured}{Only level 2 changed throughput}
  ...
  \sigcallout{The nulls were also checked directly. Swapping the loops on
    purpose makes identical arithmetic \sigemph{2.1x slower}, so the
    traversal order the baseline already had was load-bearing.}
\end{frame}
